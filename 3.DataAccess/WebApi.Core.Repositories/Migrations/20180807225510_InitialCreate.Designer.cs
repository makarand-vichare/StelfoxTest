...
namespace Net.Core.Repositories.Migrations
{
    ...
    [Migration("20180807225510_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.Claim", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.Client", b =>
                {
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.ExternalLogin", b =>
                {
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("UserId")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Localization.KeyGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Localization.LocalizationKey", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Location.City", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Location.Country", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Queues.EmailQueue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Queues.PdfQueue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Queues.RequestQueue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.Claim", b =>
                {
                    b.HasOne("Net.Core.EntityModels.Identity.User", "User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.RefreshToken", b =>
                {
                    b.HasOne("Net.Core.EntityModels.Identity.Client", "Client")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Identity.UserRole", b =>
                {
                    b.HasOne("Net.Core.EntityModels.Identity.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Net.Core.EntityModels.Location.City", b =>
                {
                    b.HasOne("Net.Core.EntityModels.Location.Country", "Country")
                        .WithMany()
